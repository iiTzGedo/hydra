...
from hydra.v1.core.deps import AuthServiceDep, CurrentUser, MongoDBDep, RegistrationAuth, require_permission
from hydra.v1.models.auth import (
    NodeApiKeyRefreshResponse,
    NodeRegistrationRequest,
    NodeRegistrationResponse,
)
from hydra.v1.models.common import PaginationMeta, SuccessResponse
from hydra.v1.models.nodes import (
    NodeClass,
    NodeKind,
    NodeListParams,
    NodeResponse,
...
from hydra.v1.services.nodes import NodeService
