      ...
      <PageHeader
        ...
        actions={
          selectedProfiles.length === 2 && (
            <Link
              href={`${ROUTES.NODES}/${nodeId}/profiles/compare?a=${selectedProfiles[0]}&b=${selectedProfiles[1]}`}
              className={cn(
              ...
              >
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <Link
                      href={`${ROUTES.NODES}/${nodeId}/profile/${profileKey}`}
