        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <Link
                href={`${ROUTES.GROUPS}/${encodeURIComponent(group.groupId)}`}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem asChild>
                <Link href={`${ROUTES.GROUPS}/${encodeURIComponent(group.groupId)}`}>
                  <Eye className="h-4 w-4 mr-2" />
                  View Members
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link href={`${ROUTES.GROUPS}/${encodeURIComponent(group.groupId)}?edit=1`}>
              ...
              <DropdownMenuItem asChild className="text-destructive">
                <Link href={`${ROUTES.GROUPS}/${encodeURIComponent(group.groupId)}?delete=1`}>
        ...
        {createdGroupId ? (
          <div className="text-center py-6">
            ...
            <div className="flex flex-col gap-3">
              <Button asChild>
                <Link href={`${ROUTES.GROUPS}/${createdGroupId}`}>
