...
export function PageHeaderLayout({
  ...
  const isTopLevelPage = typeof window !== 'undefined' && 
    ['/', '/dashboard', '/nodes', '/services', '/networks', '/discovery', '/groups', '/topology', '/time-machine', '/timemachine', '/chat', '/notifications', '/settings', '/profile', '/commands', '/integrations', '/docs'].includes(window.location.pathname);
